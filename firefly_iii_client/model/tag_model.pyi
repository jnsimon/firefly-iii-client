...
class TagModel(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["tag", "created_at", "date", "description", "latitude", "longitude", "updated_at", "zoom_level", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["tag", "created_at", "date", "description", "latitude", "longitude", "updated_at", "zoom_level", ], str]):
