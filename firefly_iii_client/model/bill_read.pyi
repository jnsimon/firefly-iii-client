...
class BillRead(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def attributes() -> typing.Type['Bill']:
                return Bill
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["attributes"]) -> 'Bill': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["attributes"]) -> 'Bill': ...
