...
class RecurrenceUpdate(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["active", "apply_rules", "description", "first_date", "notes", "nr_of_repetitions", "repeat_until", "repetitions", "title", "transactions", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["active", "apply_rules", "description", "first_date", "notes", "nr_of_repetitions", "repeat_until", "repetitions", "title", "transactions", ], str]):
