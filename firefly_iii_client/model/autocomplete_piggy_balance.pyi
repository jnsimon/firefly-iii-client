...
class AutocompletePiggyBalance(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "name", "currency_code", "currency_decimal_places", "currency_id", "currency_symbol", "name_with_balance", "object_group_id", "object_group_title", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "name", "currency_code", "currency_decimal_places", "currency_id", "currency_symbol", "name_with_balance", "object_group_id", "object_group_title", ], str]):
