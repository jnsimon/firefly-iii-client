...
class InsightTotalEntry(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["currency_code", "currency_id", "difference", "difference_float", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["currency_code", "currency_id", "difference", "difference_float", ], str]):
