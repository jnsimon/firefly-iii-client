...
class TransactionSplitStore(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["amount", "date", "description", "type", "bill_id", "bill_name", "book_date", "budget_id", "budget_name", "bunq_payment_id", "category_id", "category_name", "currency_code", "currency_id", "destination_id", "destination_name", "due_date", "external_id", "external_url", "foreign_amount", "foreign_currency_code", "foreign_currency_id", "interest_date", "internal_reference", "invoice_date", "notes", "order", "payment_date", "piggy_bank_id", "piggy_bank_name", "process_date", "reconciled", "sepa_batch_id", "sepa_cc", "sepa_ci", "sepa_country", "sepa_ct_id", "sepa_ct_op", "sepa_db", "sepa_ep", "source_id", "source_name", "tags", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        piggy_bank_id: typing.Union[MetaOapg.properties.piggy_bank_id, None, decimal.Decimal, int, schemas.Unset] = schemas.unset,
