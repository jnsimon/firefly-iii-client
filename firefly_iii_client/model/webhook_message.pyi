...
class WebhookMessage(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["created_at", "errored", "message", "sent", "updated_at", "uuid", "webhook_id", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["created_at", "errored", "message", "sent", "updated_at", "uuid", "webhook_id", ], str]):
