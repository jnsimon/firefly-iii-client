...
class TagModelUpdate(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["date", "description", "latitude", "longitude", "tag", "zoom_level", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["date", "description", "latitude", "longitude", "tag", "zoom_level", ], str]):
