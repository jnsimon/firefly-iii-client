...
class TransactionLinkStore(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["inward_id", "link_type_id", "outward_id", "link_type_name", "notes", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["inward_id", "link_type_id", "outward_id", "link_type_name", "notes", ], str]):
