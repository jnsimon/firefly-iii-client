...
from firefly_iii_client.exceptions import ApiTypeError, ApiValueError
from firefly_iii_client.schemas import (
    NoneClass,
    BoolClass,
    Schema,
    FileIO,
...
class ApiClient:
    ...
    def __init__(
        ...
        self.user_agent = 'OpenAPI-Generator/2.0.12.0/python'
