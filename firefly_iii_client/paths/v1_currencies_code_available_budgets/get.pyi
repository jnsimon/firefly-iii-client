...
SchemaFor200ResponseBodyApplicationVndApijson = AvailableBudgetArray
...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_available_budget_by_currency_oapg(
        self,
...
class ListAvailableBudgetByCurrency(BaseApi):
    ...
    def list_available_budget_by_currency(
        ...
        return self._list_available_budget_by_currency_oapg(
