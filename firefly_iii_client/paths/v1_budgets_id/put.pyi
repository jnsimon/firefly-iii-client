...
# body param
SchemaForRequestBodyApplicationJson = BudgetUpdate
SchemaForRequestBodyApplicationXWwwFormUrlencoded = BudgetUpdate


request_body_budget_update = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _update_budget_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_budget_update.serialize(body, content_type)
