...
# body param
SchemaForRequestBodyApplicationJson = RuleGroupUpdate
SchemaForRequestBodyApplicationXWwwFormUrlencoded = RuleGroupUpdate


request_body_rule_group_update = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationVndApijson = RuleGroupSingle
...
class BaseApi(api_client.Api):
    ...
    def _update_rule_group_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_rule_group_update.serialize(body, content_type)
...
class UpdateRuleGroup(BaseApi):
    ...
    def update_rule_group(
        ...
        return self._update_rule_group_oapg(
            body=body,
