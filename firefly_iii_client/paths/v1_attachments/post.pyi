...
# body param
SchemaForRequestBodyApplicationJson = AttachmentStore
SchemaForRequestBodyApplicationXWwwFormUrlencoded = AttachmentStore


request_body_attachment_store = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _store_attachment_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_attachment_store.serialize(body, content_type)
...
class StoreAttachment(BaseApi):
    ...
    def store_attachment(
        ...
        return self._store_attachment_oapg(
            body=body,
