...
# body param
SchemaForRequestBodyApplicationJson = TagModelStore
SchemaForRequestBodyApplicationXWwwFormUrlencoded = TagModelStore


request_body_tag_model_store = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _store_tag_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_tag_model_store.serialize(body, content_type)
