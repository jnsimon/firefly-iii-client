...
# body param
SchemaForRequestBodyApplicationJson = LinkTypeUpdate
SchemaForRequestBodyApplicationXWwwFormUrlencoded = LinkTypeUpdate


request_body_link_type_update = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationVndApijson = LinkTypeSingle
...
class BaseApi(api_client.Api):
    ...
    def _update_link_type_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_link_type_update.serialize(body, content_type)
...
class UpdateLinkType(BaseApi):
    ...
    def update_link_type(
        ...
        return self._update_link_type_oapg(
            body=body,
