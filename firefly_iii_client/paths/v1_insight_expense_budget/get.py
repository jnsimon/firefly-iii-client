...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'budgets[]': typing.Union[BudgetsSchema, list, tuple, ],
...
request_query_budgets = api_client.QueryParameter(
    name="budgets[]",
    style=api_client.ParameterStyle.FORM,
...
class BaseApi(api_client.Api):
    @typing.overload
    def _insight_expense_budget_oapg(
        self,
...
class InsightExpenseBudget(BaseApi):
    ...
    def insight_expense_budget(
        ...
        return self._insight_expense_budget_oapg(
