...
SchemaFor204ResponseBodyApplicationVndApijson = CurrencySingle
...
_response_for_204 = api_client.OpenApiResponse(
    ...
    content={
        'application/vnd.api+json': api_client.MediaType(
            schema=SchemaFor204ResponseBodyApplicationVndApijson),
    },
)
...
class DefaultCurrency(BaseApi):
    ...
    def default_currency(
        ...
        return self._default_currency_oapg(
