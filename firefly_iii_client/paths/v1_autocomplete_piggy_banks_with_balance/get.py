...
SchemaFor200ResponseBodyApplicationJson = AutocompletePiggyBalanceArray
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_piggies_balance_ac_oapg(
        self,
...
class GetPiggiesBalanceAc(BaseApi):
    ...
    def get_piggies_balance_ac(
        ...
        return self._get_piggies_balance_ac_oapg(
