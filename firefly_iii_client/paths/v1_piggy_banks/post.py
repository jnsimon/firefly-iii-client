...
# body param
SchemaForRequestBodyApplicationJson = PiggyBankStore
SchemaForRequestBodyApplicationXWwwFormUrlencoded = PiggyBankStore


request_body_piggy_bank_store = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _store_piggy_bank_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_piggy_bank_store.serialize(body, content_type)
...
class StorePiggyBank(BaseApi):
    ...
    def store_piggy_bank(
        ...
        return self._store_piggy_bank_oapg(
            body=body,
