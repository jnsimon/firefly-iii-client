...
SchemaFor200ResponseBodyApplicationVndApijson = WebhookAttemptSingle
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_single_webhook_message_attempt_oapg(
        self,
...
class GetSingleWebhookMessageAttempt(BaseApi):
    ...
    def get_single_webhook_message_attempt(
        ...
        return self._get_single_webhook_message_attempt_oapg(
