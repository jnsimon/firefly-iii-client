...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'currency_code': typing.Union[CurrencyCodeSchema, str, ],
    },
    total=False
)
...
SchemaFor200ResponseBodyApplicationVndApijson = BasicSummary
...
class GetBasicSummary(BaseApi):
    ...
    def get_basic_summary(
        ...
        return self._get_basic_summary_oapg(
