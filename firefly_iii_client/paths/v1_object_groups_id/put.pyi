...
# body param
SchemaForRequestBodyApplicationJson = ObjectGroupUpdate
SchemaForRequestBodyApplicationXWwwFormUrlencoded = ObjectGroupUpdate


request_body_object_group_update = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationVndApijson = ObjectGroupSingle
...
class BaseApi(api_client.Api):
    ...
    def _update_object_group_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_object_group_update.serialize(body, content_type)
...
class UpdateObjectGroup(BaseApi):
    ...
    def update_object_group(
        ...
        return self._update_object_group_oapg(
            body=body,
