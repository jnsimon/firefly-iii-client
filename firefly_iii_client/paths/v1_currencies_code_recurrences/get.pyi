...
SchemaFor200ResponseBodyApplicationVndApijson = RecurrenceArray
...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_recurrence_by_currency_oapg(
        self,
...
class ListRecurrenceByCurrency(BaseApi):
    ...
    def list_recurrence_by_currency(
        ...
        return self._list_recurrence_by_currency_oapg(
