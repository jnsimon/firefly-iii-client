...
# body param
SchemaForRequestBodyApplicationVndApijson = CurrencyUpdate
SchemaForRequestBodyApplicationXWwwFormUrlencoded = CurrencyUpdate


request_body_currency_update = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _update_currency_oapg(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationVndApijson,SchemaForRequestBodyApplicationXWwwFormUrlencoded,],
        content_type: str = ...,
        header_params: RequestHeaderParams = frozendict.frozendict(),
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def _update_currency_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_currency_update.serialize(body, content_type)
...
class UpdateCurrency(BaseApi):
    ...
    def update_currency(
        ...
        return self._update_currency_oapg(
            body=body,
