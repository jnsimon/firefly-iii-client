...
SchemaFor200ResponseBodyApplicationJson = AutocompleteRuleGroupArray
...
class GetRuleGroupsAc(BaseApi):
    ...
    def get_rule_groups_ac(
        ...
        return self._get_rule_groups_ac_oapg(
