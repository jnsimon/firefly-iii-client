...
# body param
SchemaForRequestBodyApplicationJson = WebhookUpdate
SchemaForRequestBodyApplicationXWwwFormUrlencoded = WebhookUpdate


request_body_webhook_update = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _update_webhook_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_webhook_update.serialize(body, content_type)
...
class UpdateWebhook(BaseApi):
    ...
    def update_webhook(
        ...
        return self._update_webhook_oapg(
            body=body,
