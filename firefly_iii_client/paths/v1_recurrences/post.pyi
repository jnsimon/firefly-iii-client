...
# body param
SchemaForRequestBodyApplicationJson = RecurrenceStore
SchemaForRequestBodyApplicationXWwwFormUrlencoded = RecurrenceStore


request_body_recurrence_store = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _store_recurrence_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_recurrence_store.serialize(body, content_type)
...
class StoreRecurrence(BaseApi):
    ...
    def store_recurrence(
        ...
        return self._store_recurrence_oapg(
            body=body,
