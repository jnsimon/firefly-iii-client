...
SchemaFor200ResponseBodyApplicationVndApijson = BillArray
...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_bill_by_object_group_oapg(
        self,
...
class ListBillByObjectGroup(BaseApi):
    ...
    def list_bill_by_object_group(
        ...
        return self._list_bill_by_object_group_oapg(
