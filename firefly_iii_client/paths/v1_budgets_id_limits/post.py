...
# body param
SchemaForRequestBodyApplicationJson = BudgetLimitStore
SchemaForRequestBodyApplicationXWwwFormUrlencoded = BudgetLimitStore


request_body_budget_limit_store = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationVndApijson = BudgetLimitSingle
...
class BaseApi(api_client.Api):
    ...
    def _store_budget_limit_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_budget_limit_store.serialize(body, content_type)
...
class StoreBudgetLimit(BaseApi):
    ...
    def store_budget_limit(
        ...
        return self._store_budget_limit_oapg(
            body=body,
