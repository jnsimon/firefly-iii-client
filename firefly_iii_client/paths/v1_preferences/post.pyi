...
# body param
SchemaForRequestBodyApplicationJson = Preference
SchemaForRequestBodyApplicationXWwwFormUrlencoded = Preference


request_body_preference = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _store_preference_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_preference.serialize(body, content_type)
...
class StorePreference(BaseApi):
    ...
    def store_preference(
        ...
        return self._store_preference_oapg(
            body=body,
