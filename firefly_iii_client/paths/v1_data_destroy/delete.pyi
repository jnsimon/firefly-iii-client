...
# Query params
ObjectsSchema = DataDestroyObject
RequestRequiredQueryParams = typing_extensions.TypedDict(
    'RequestRequiredQueryParams',
    {
        'objects': typing.Union[ObjectsSchema, ],
    }
)
...
request_query_objects = api_client.QueryParameter(
    name="objects",
...
class DestroyData(BaseApi):
    ...
    def destroy_data(
        ...
        return self._destroy_data_oapg(
