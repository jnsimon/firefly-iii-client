...
SchemaFor200ResponseBodyApplicationVndApijson = BudgetLimitArray
...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_budget_limit_by_currency_oapg(
        self,
...
class ListBudgetLimitByCurrency(BaseApi):
    ...
    def list_budget_limit_by_currency(
        ...
        return self._list_budget_limit_by_currency_oapg(
