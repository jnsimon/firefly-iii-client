...
# body param
SchemaForRequestBodyApplicationJson = AccountUpdate
SchemaForRequestBodyApplicationXWwwFormUrlencoded = AccountUpdate


request_body_account_update = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationVndApijson = AccountSingle
...
class BaseApi(api_client.Api):
    ...
    def _update_account_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_account_update.serialize(body, content_type)
...
class UpdateAccount(BaseApi):
    ...
    def update_account(
        ...
        return self._update_account_oapg(
            body=body,
