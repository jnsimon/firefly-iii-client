...
SchemaFor200ResponseBodyApplicationJson = AutocompleteObjectGroupArray
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_object_groups_ac_oapg(
        self,
...
class GetObjectGroupsAc(BaseApi):
    ...
    def get_object_groups_ac(
        ...
        return self._get_object_groups_ac_oapg(
