...
# body param
SchemaForRequestBodyApplicationJson = RuleStore
SchemaForRequestBodyApplicationXWwwFormUrlencoded = RuleStore


request_body_rule_store = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _store_rule_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_rule_store.serialize(body, content_type)
