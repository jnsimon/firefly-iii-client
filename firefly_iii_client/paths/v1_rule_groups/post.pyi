...
# body param
SchemaForRequestBodyApplicationJson = RuleGroupStore
SchemaForRequestBodyApplicationXWwwFormUrlencoded = RuleGroupStore


request_body_rule_group_store = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _store_rule_group_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_rule_group_store.serialize(body, content_type)
...
class StoreRuleGroup(BaseApi):
    ...
    def store_rule_group(
        ...
        return self._store_rule_group_oapg(
            body=body,
