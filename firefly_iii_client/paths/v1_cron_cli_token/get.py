...
# Path params
CliTokenSchema = schemas.StrSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'cliToken': typing.Union[CliTokenSchema, str, ],
    }
)
...
request_path_cli_token = api_client.PathParameter(
    name="cliToken",
    style=api_client.ParameterStyle.SIMPLE,
    schema=CliTokenSchema,
    required=True,
)
_auth = [
    'firefly_iii_auth',
...
SchemaFor200ResponseBodyApplicationJson = CronResult
