...
class TypesSchema(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['AccountTypeFilter']:
            return AccountTypeFilter

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['AccountTypeFilter'], typing.List['AccountTypeFilter']],
    ...
    def __getitem__(self, i: int) -> 'AccountTypeFilter':
...
SchemaFor200ResponseBodyApplicationJson = AutocompleteAccountArray
...
class GetAccountsAc(BaseApi):
    ...
    def get_accounts_ac(
        ...
        return self._get_accounts_ac_oapg(
