...
# Path params
NameSchema = ConfigValueUpdateFilter
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'name': typing.Union[NameSchema, ],
    }
)
...
# body param
SchemaForRequestBodyApplicationJson = ConfigurationUpdate
SchemaForRequestBodyApplicationXWwwFormUrlencoded = ConfigurationUpdate


request_body_configuration_update = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ConfigurationSingle
...
class BaseApi(api_client.Api):
    ...
    def _set_configuration_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_configuration_update.serialize(body, content_type)
...
class SetConfiguration(BaseApi):
    ...
    def set_configuration(
        ...
        return self._set_configuration_oapg(
            body=body,
