...
request_path_tag = api_client.PathParameter(
    name="tag",
    style=api_client.ParameterStyle.SIMPLE,
    schema=TagSchema,
    required=True,
...
# body param
SchemaForRequestBodyApplicationJson = TagModelUpdate
SchemaForRequestBodyApplicationXWwwFormUrlencoded = TagModelUpdate


request_body_tag_model_update = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationVndApijson = TagSingle
...
class BaseApi(api_client.Api):
    ...
    def _update_tag_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_tag_model_update.serialize(body, content_type)
