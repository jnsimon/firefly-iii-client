...
# body param
SchemaForRequestBodyApplicationJson = CurrencyStore
SchemaForRequestBodyApplicationXWwwFormUrlencoded = CurrencyStore


request_body_currency_store = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationVndApijson = CurrencySingle
...
class BaseApi(api_client.Api):
    ...
    def _store_currency_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_currency_store.serialize(body, content_type)
...
class StoreCurrency(BaseApi):
    ...
    def store_currency(
        ...
        return self._store_currency_oapg(
            body=body,
