...
SchemaFor200ResponseBodyApplicationJson = AutocompleteTransactionArray
...
class GetTransactionsAc(BaseApi):
    ...
    def get_transactions_ac(
        ...
        return self._get_transactions_ac_oapg(
