...
# body param
SchemaForRequestBodyApplicationJson = AccountStore
SchemaForRequestBodyApplicationXWwwFormUrlencoded = AccountStore


request_body_account_store = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _store_account_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_account_store.serialize(body, content_type)
...
class StoreAccount(BaseApi):
    ...
    def store_account(
        ...
        return self._store_account_oapg(
            body=body,
