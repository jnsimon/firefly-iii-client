...
# body param
SchemaForRequestBodyApplicationJson = RecurrenceUpdate
SchemaForRequestBodyApplicationXWwwFormUrlencoded = RecurrenceUpdate


request_body_recurrence_update = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationVndApijson = RecurrenceSingle
...
class BaseApi(api_client.Api):
    ...
    def _update_recurrence_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_recurrence_update.serialize(body, content_type)
...
class UpdateRecurrence(BaseApi):
    ...
    def update_recurrence(
        ...
        return self._update_recurrence_oapg(
            body=body,
