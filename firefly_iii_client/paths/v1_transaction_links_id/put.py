...
# body param
SchemaForRequestBodyApplicationJson = TransactionLinkUpdate
SchemaForRequestBodyApplicationXWwwFormUrlencoded = TransactionLinkUpdate


request_body_transaction_link_update = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationVndApijson = TransactionLinkSingle
...
class BaseApi(api_client.Api):
    @typing.overload
    def _update_transaction_link_oapg(
        self,
    ...
    def _update_transaction_link_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_transaction_link_update.serialize(body, content_type)
...
class UpdateTransactionLink(BaseApi):
    ...
    def update_transaction_link(
        ...
        return self._update_transaction_link_oapg(
            body=body,
