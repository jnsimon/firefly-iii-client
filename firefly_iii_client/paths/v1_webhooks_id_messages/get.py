...
SchemaFor200ResponseBodyApplicationVndApijson = WebhookMessageArray
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_webhook_messages_oapg(
        self,
...
class GetWebhookMessages(BaseApi):
    ...
    def get_webhook_messages(
        ...
        return self._get_webhook_messages_oapg(
