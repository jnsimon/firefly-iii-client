...
# body param
SchemaForRequestBodyApplicationJson = PreferenceUpdate
SchemaForRequestBodyApplicationXWwwFormUrlencoded = PreferenceUpdate


request_body_preference_update = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationVndApijson = PreferenceSingle
...
class BaseApi(api_client.Api):
    ...
    def _update_preference_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_preference_update.serialize(body, content_type)
...
class UpdatePreference(BaseApi):
    ...
    def update_preference(
        ...
        return self._update_preference_oapg(
            body=body,
