...
LimitIdSchema = schemas.IntSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'id': typing.Union[IdSchema, str, ],
        'limitId': typing.Union[LimitIdSchema, decimal.Decimal, int, ],
    }
)
...
class GetBudgetLimit(BaseApi):
    ...
    def get_budget_limit(
        ...
        return self._get_budget_limit_oapg(
