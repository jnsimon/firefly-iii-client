...
# body param
SchemaForRequestBodyApplicationJson = BudgetLimit
SchemaForRequestBodyApplicationXWwwFormUrlencoded = BudgetLimit


request_body_budget_limit = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _update_budget_limit_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_budget_limit.serialize(body, content_type)
...
class UpdateBudgetLimit(BaseApi):
    ...
    def update_budget_limit(
        ...
        return self._update_budget_limit_oapg(
            body=body,
