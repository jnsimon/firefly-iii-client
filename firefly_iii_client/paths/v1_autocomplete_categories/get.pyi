...
SchemaFor200ResponseBodyApplicationJson = AutocompleteCategoryArray
...
class GetCategoriesAc(BaseApi):
    ...
    def get_categories_ac(
        ...
        return self._get_categories_ac_oapg(
