...
SchemaFor200ResponseBodyApplicationJson = TransactionArray
...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_transaction_by_link_type_oapg(
        self,
...
class ListTransactionByLinkType(BaseApi):
    ...
    def list_transaction_by_link_type(
        ...
        return self._list_transaction_by_link_type_oapg(
