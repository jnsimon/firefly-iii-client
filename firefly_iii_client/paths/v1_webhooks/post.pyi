...
# body param
SchemaForRequestBodyApplicationJson = WebhookStore
SchemaForRequestBodyApplicationXWwwFormUrlencoded = WebhookStore


request_body_webhook_store = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationVndApijson = WebhookSingle
...
class BaseApi(api_client.Api):
    ...
    def _store_webhook_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_webhook_store.serialize(body, content_type)
...
class StoreWebhook(BaseApi):
    ...
    def store_webhook(
        ...
        return self._store_webhook_oapg(
            body=body,
