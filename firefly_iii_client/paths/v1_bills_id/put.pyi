...
# body param
SchemaForRequestBodyApplicationJson = BillUpdate
SchemaForRequestBodyApplicationXWwwFormUrlencoded = BillUpdate


request_body_bill_update = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationVndApijson = BillSingle
...
class BaseApi(api_client.Api):
    ...
    def _update_bill_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_bill_update.serialize(body, content_type)
