...
SchemaFor200ResponseBodyApplicationVndApijson = RuleArray
...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_rule_by_currency_oapg(
        self,
...
class ListRuleByCurrency(BaseApi):
    ...
    def list_rule_by_currency(
        ...
        return self._list_rule_by_currency_oapg(
