...
TypeSchema = AccountTypeFilter
FieldSchema = AccountSearchFieldFilter
RequestRequiredQueryParams = typing_extensions.TypedDict(
    'RequestRequiredQueryParams',
    {
        'query': typing.Union[QuerySchema, str, ],
        'field': typing.Union[FieldSchema, ],
    }
)
...
SchemaFor200ResponseBodyApplicationVndApijson = AccountArray
...
class SearchAccounts(BaseApi):
    ...
    def search_accounts(
        ...
        return self._search_accounts_oapg(
