...
SchemaFor200ResponseBodyApplicationJson = AutocompleteTransactionTypeArray
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_transaction_types_ac_oapg(
        self,
...
class GetTransactionTypesAc(BaseApi):
    ...
    def get_transaction_types_ac(
        ...
        return self._get_transaction_types_ac_oapg(
