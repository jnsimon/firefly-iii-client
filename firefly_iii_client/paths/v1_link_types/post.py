...
# body param
SchemaForRequestBodyApplicationJson = LinkType
SchemaForRequestBodyApplicationXWwwFormUrlencoded = LinkType


request_body_link_type = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _store_link_type_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_link_type.serialize(body, content_type)
...
class StoreLinkType(BaseApi):
    ...
    def store_link_type(
        ...
        return self._store_link_type_oapg(
            body=body,
