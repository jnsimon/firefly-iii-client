...
# body param
SchemaForRequestBodyApplicationJson = RuleUpdate
SchemaForRequestBodyApplicationXWwwFormUrlencoded = RuleUpdate


request_body_rule_update = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationVndApijson = RuleSingle
...
class BaseApi(api_client.Api):
    ...
    def _update_rule_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_rule_update.serialize(body, content_type)
