...
# body param
SchemaForRequestBodyApplicationJson = Category
SchemaForRequestBodyApplicationXWwwFormUrlencoded = Category


request_body_category = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _store_category_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_category.serialize(body, content_type)
...
class StoreCategory(BaseApi):
    ...
    def store_category(
        ...
        return self._store_category_oapg(
            body=body,
