...
SchemaFor200ResponseBodyApplicationJson = AutocompleteCurrencyArray
...
class GetCurrenciesAc(BaseApi):
    ...
    def get_currencies_ac(
        ...
        return self._get_currencies_ac_oapg(
