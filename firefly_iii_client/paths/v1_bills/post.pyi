...
# body param
SchemaForRequestBodyApplicationJson = BillStore
SchemaForRequestBodyApplicationXWwwFormUrlencoded = BillStore


request_body_bill_store = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _store_bill_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_bill_store.serialize(body, content_type)
