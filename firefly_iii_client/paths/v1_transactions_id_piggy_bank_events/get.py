...
SchemaFor200ResponseBodyApplicationVndApijson = PiggyBankEventArray
...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_event_by_transaction_oapg(
        self,
...
class ListEventByTransaction(BaseApi):
    ...
    def list_event_by_transaction(
        ...
        return self._list_event_by_transaction_oapg(
