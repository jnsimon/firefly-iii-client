...
SchemaFor200ResponseBodyApplicationVndApijson = ObjectGroupArray
...
class ListObjectGroups(BaseApi):
    ...
    def list_object_groups(
        ...
        return self._list_object_groups_oapg(
