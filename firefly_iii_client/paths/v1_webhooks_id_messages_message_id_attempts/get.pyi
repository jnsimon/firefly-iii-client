...
SchemaFor200ResponseBodyApplicationVndApijson = WebhookAttemptArray
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_webhook_message_attempts_oapg(
        self,
...
class GetWebhookMessageAttempts(BaseApi):
    ...
    def get_webhook_message_attempts(
        ...
        return self._get_webhook_message_attempts_oapg(
