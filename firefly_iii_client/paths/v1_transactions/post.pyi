...
# body param
SchemaForRequestBodyApplicationJson = TransactionStore
SchemaForRequestBodyApplicationXWwwFormUrlencoded = TransactionStore


request_body_transaction_store = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _store_transaction_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_transaction_store.serialize(body, content_type)
...
class StoreTransaction(BaseApi):
    ...
    def store_transaction(
        ...
        return self._store_transaction_oapg(
            body=body,
