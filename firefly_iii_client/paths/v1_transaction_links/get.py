...
SchemaFor200ResponseBodyApplicationVndApijson = TransactionLinkArray
...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_transaction_link_oapg(
        self,
...
class ListTransactionLink(BaseApi):
    ...
    def list_transaction_link(
        ...
        return self._list_transaction_link_oapg(
