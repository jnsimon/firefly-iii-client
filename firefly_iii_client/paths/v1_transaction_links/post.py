...
# body param
SchemaForRequestBodyApplicationJson = TransactionLinkStore
SchemaForRequestBodyApplicationXWwwFormUrlencoded = TransactionLinkStore


request_body_transaction_link_store = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    @typing.overload
    def _store_transaction_link_oapg(
        self,
    ...
    def _store_transaction_link_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_transaction_link_store.serialize(body, content_type)
...
class StoreTransactionLink(BaseApi):
    ...
    def store_transaction_link(
        ...
        return self._store_transaction_link_oapg(
            body=body,
