...
SchemaFor200ResponseBodyApplicationJson = AutocompleteTransactionIDArray
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_transactions_idac_oapg(
        self,
...
class GetTransactionsIdac(BaseApi):
    ...
    def get_transactions_idac(
        ...
        return self._get_transactions_idac_oapg(
