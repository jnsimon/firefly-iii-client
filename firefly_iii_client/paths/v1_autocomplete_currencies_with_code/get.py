...
SchemaFor200ResponseBodyApplicationJson = AutocompleteCurrencyCodeArray
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_currencies_code_ac_oapg(
        self,
...
class GetCurrenciesCodeAc(BaseApi):
    ...
    def get_currencies_code_ac(
        ...
        return self._get_currencies_code_ac_oapg(
