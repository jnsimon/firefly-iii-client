...
# body param
SchemaForRequestBodyApplicationJson = AttachmentUpdate
SchemaForRequestBodyApplicationXWwwFormUrlencoded = AttachmentUpdate


request_body_attachment_update = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationVndApijson = AttachmentSingle
...
class BaseApi(api_client.Api):
    ...
    def _update_attachment_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_attachment_update.serialize(body, content_type)
...
class UpdateAttachment(BaseApi):
    ...
    def update_attachment(
        ...
        return self._update_attachment_oapg(
            body=body,
